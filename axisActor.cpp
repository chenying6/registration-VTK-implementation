...
vtkStandardNewMacro(AxisActor);

vtkCxxSetObjectMacro(AxisActor, UserDefinedTip, vtkPolyData);
vtkCxxSetObjectMacro(AxisActor, UserDefinedShaft, vtkPolyData);
//----------------------------------------------------------------------------
AxisActor::AxisActor()
{
	this->AxisLabels = 1;
	...
	this->ShaftType = AxisActor::LINE_SHAFT;
	this->TipType = AxisActor::CONE_TIP;
...
//void AxisActor::ShallowCopy(vtkProp *prop)
//{
//	AxisActor *a = AxisActor::SafeDownCast(prop);
//	if (a != nullptr)
//	{
...
//----------------------------------------------------------------------------
void AxisActor::GetActors(vtkPropCollection *ac)
{
...
//----------------------------------------------------------------------------
int AxisActor::RenderOpaqueGeometry(vtkViewport *vp)
{
...
//-----------------------------------------------------------------------------
int AxisActor::RenderTranslucentPolygonalGeometry(vtkViewport *vp)
{
	int renderedSomething = 0;
...
int AxisActor::HasTranslucentPolygonalGeometry()
{
	int result = 0;
...
//-----------------------------------------------------------------------------
int AxisActor::RenderOverlay(vtkViewport *vp)
{
	int renderedSomething = 0;
...
//----------------------------------------------------------------------------
void AxisActor::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------------
void AxisActor::GetBounds(double bounds[6])
{
...
//----------------------------------------------------------------------------
vtkMTimeType AxisActor::GetMTime()
{
...
//----------------------------------------------------------------------------
vtkMTimeType AxisActor::GetRedrawMTime()
{
...
//----------------------------------------------------------------------------
void AxisActor::SetTotalLength(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void AxisActor::SetNormalizedShaftLength(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void AxisActor::SetNormalizedTipLength(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void AxisActor::SetNormalizedLabelPosition(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void AxisActor::SetShaftType(int type)
{
	if (this->ShaftType != type)
	{
		if (type < AxisActor::CYLINDER_SHAFT || \
			type > AxisActor::USER_DEFINED_SHAFT)
		{
			vtkErrorMacro("Undefined axes shaft type.");
			return;
		}

		if (type == AxisActor::USER_DEFINED_SHAFT && \
			this->UserDefinedShaft == nullptr)
		{
...
//----------------------------------------------------------------------------
void AxisActor::SetTipType(int type)
{
	if (this->TipType != type)
	{
		if (type < AxisActor::CONE_TIP || \
			type > AxisActor::USER_DEFINED_TIP)
		{
			vtkErrorMacro("Undefined axes tip type.");
			return;
		}

		if (type == AxisActor::USER_DEFINED_TIP && \
			this->UserDefinedTip == nullptr)
		{
...
//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetXAxisTipProperty()
{
	return this->XAxisTip->GetProperty();
}

//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetYAxisTipProperty()
{
	return this->YAxisTip->GetProperty();
}

//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetZAxisTipProperty()
{
	return this->ZAxisTip->GetProperty();
}

//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetXAxisShaftProperty()
{
	return this->XAxisShaft->GetProperty();
}

//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetYAxisShaftProperty()
{
	return this->YAxisShaft->GetProperty();
}

//----------------------------------------------------------------------------
vtkProperty *AxisActor::GetZAxisShaftProperty()
{
	return this->ZAxisShaft->GetProperty();
}

//----------------------------------------------------------------------------
void AxisActor::PrintSelf(ostream& os, vtkIndent indent)
{
